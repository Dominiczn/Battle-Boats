...
Binary writer / reader is used to save the progress. Lines 422 - 563Turn based game loop is used to keep the game running until someone wins, swapping between user and computer turns each cycle. Lines 126 - 170
